...
class TestBreeder(unittest.TestCase):
    ...
    def test_breed(self):
        ...
        expected_children = (Individual('01010'), Individual('01010'))
        children = self._breeder.breed(Individual('01010'), Individual('00111'))
        self.assertEqual(expected_children, children)

    def test_uniform_crossover(self):
        seed(1)
        expected_child = Individual('10001')
        child = self._breeder._uniform_crossover(Individual('01011'), Individual('10100'))
